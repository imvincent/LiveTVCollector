...
class M3UCollector:
    def __init__(self, country="China", base_dir="LiveTV", check_links=True):
...
def main():
    ...
    collector = M3UCollector(country="China", check_links=False)
    ...
    logging.info(f"[{mumbai_time}] Collected {total_channels} unique channels for China")
